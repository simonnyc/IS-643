---
title: "Assignment01"
author: "Mohamed Elmoudni, Shazia Khan, Senthil Dhanapal"
...
#### Cosine similarity matrix for items
...
####  Recommendation for User 10 using IBCF 
...
Prediction for same user 10 using User based collobarative filtering (UBCF)
...
from the below comparaison table, most of the rating values are similar using different methods. However, we observed some outliers.
For item7, the outlier value  0.7561378 is produced by user-defined UBCF-Pearson. 
For item 10, the outlier value  1.384313 is produced by Recommender UBCF Cosine. 



```{r, warning=FALSE, message=FALSE}

dt_conc<-read.csv("https://raw.githubusercontent.com/simonnyc/IS-643/master/Proj01conclusion.csv", header=TRUE)
