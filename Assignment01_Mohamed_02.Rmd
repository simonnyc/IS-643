...
Following line predicts the ratings for 

```{r}
userRecmd(10)
```

Following lines predict the ratings for the user 10 but using built-in package :- RecommenderLab package.
```{r}
...
Rec.model<-Recommender(affinity.matrix,method="IBCF", 
                       param=list(normalize = "Z-score",method="Cosine", n=5))
...
The numbers are slightly off compared to our user defined functon but not by much.
